...
export const Hero = () => {
  return (
    <section className="relative w-full bg-brand-darkpt-20 pb-32 mt-10 overflow-hidden">
      {/* Container */}
      <div className="max-w-300 mx-auto px-6 flex flex-col lg:flex-row items-center relative z-10">
        {/* Content */}
        <div className="w-full lg:w-[55%] flex flex-col items-start z-20">
          <h1 className="text-5xl lg:text-[64px] font-bold text-white leading-[1.15]">
            We Forge Digital
            <br />
            Experiences That
            <br />
          ...
          <p className="mt-6 text-gray-400 text-[17px] max-w-120 leading-relaxed">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <button className="bg-blue-600 text-white px-7 py-3 rounded-md font-medium hover:bg-blue-700 transition-colors flex items-center gap-2">
